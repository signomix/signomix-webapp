            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" class="col-1">{offset+1+index}</th>
                            <td class="col-9"><a href="/organization/templates/{config.id}">{config.title}</a></td>
                            <td class="col-2">
    ...
    <div class="row">
        <div class="col-2">
            ...
            <a class="btn btn-outline-primary" role="button"
                href="/organization/templates/new/edit">{utils.getLabel('add',labels,$language)}</a>
            {/if}
        </div>
        <div class="col-10">
...
<script>
    ...
    async function getConfigs() {
        ...
        if (dev) {
            ...
            let url = utils.getBackendUrl(location) + "/api/core/templates"
