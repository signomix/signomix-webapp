...
<div class="demo-container size">
    <Grid bind:items={items} rowHeight={100} let:item {cols} let:index>
        <div class="demo-widget content bg-white border border-primary">
            <CanvasWidget index={index} bind:config={widgets}/>
        </div>
    </Grid>
</div>
<script>
    ...
    let items = [
        ...
        },
        {
            ...
            6: item({ x: 2, w: 1, h: 2, y: 0, draggable: editable, resizable: editable, }),
            1: item({ x: 0, y: 2, w: 1, h: 2, draggable: editable, resizable: editable, }),
        },

        {
            ...
            6: item({ x: 0, w: 3, h: 2, y: 2, draggable: editable, resizable: editable, }),
            1: item({ x: 0, y: 4, w: 1, h: 2, draggable: editable, resizable: editable, }),
        },
    ];
