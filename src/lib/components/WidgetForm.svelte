            ...
            <div class="p-1 mt-2">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="input-title"
                        placeholder="Widget's title" bind:value={widget.title}>
                </div>
                <div class="mb-2">
                    <label for="type">Type</label>
                    <select id="input-type" class="form-control form-control-sm" >
                        {#each widgets.types as widgetType}
                        <option selected={widgetType==widget.type} value={widgetType}>{widgetType}</option>
                        {/each}
                    </select>
                </div>
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="input-eui"
                        placeholder="EUI of the device" bind:value={widget.eui}>
                </div>
            </div>
            {/if}
            ...
            <div class="p-1 mt-2">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="input-channels"
                        placeholder="Measurement names" bind:value={widget.channels}>
                </div>
                <div class="mb-2">
