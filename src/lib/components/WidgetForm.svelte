    ...
    function resetSettings() {
        ...
        try {
            ...
            if (
                ...
                config[index].dev_id != undefined &&
                config[index].dev_id != null &&
                config[index].dev_id != ""
            ) {
                singleDeviceMode = 1;
            } else if (
                config[index].group != undefined &&
                config[index].group != null &&
                config[index].group != ""
            ) {
                singleDeviceMode = 0;
            } else {
                if (
                    config[index].type == "groupchart" ||
                    config[index].type == "multimap" ||
                    config[index].type == "plan" ||
                    config[index].type == "report"
                ) {
                    singleDeviceMode = 0;
                } else {
...
<!--
    ...
    https://www.sveltesociety.dev/recipes/svelte-language-fundamentals/reactivity
-->
<div class="text-right p-1">
    <div class="container">
            ...
            <form>
                <nav>
                    <div class="nav nav-underline" id="nav-tab">
                        {#if activeTabs.basic}
                            <a
                                class="nav-link {selectedTab === 'basic'
                                    ? 'active'
                                    : ''}"
                                type="button"
                                on:click={selectBasic}
                                >{utils.getLabel("basic", labels, $language)}</a
                            >
                        {/if}
                        {#if activeTabs.extended}
                            <a
                                class="nav-link {selectedTab === 'extended'
                                    ? 'active'
                                    : ''}"
                                type="button"
                                on:click={selectExtended}
                                >{utils.getLabel(
                                    "details",
                                    labels,
                                    $language,
                        ...
                        {#if activeTabs.chart}
                            <a
                                class="nav-link {selectedTab === 'chart'
                                    ? 'active'
                                    : ''}"
                                type="button"
                                on:click={selectChart}
                                >{utils.getLabel(
                                    "chart_opt",
                                    labels,
                                    $language,
                        ...
                        {#if activeTabs.config}
                            <a
                                class="nav-link {selectedTab === 'config'
                                    ? 'active'
                                    : ''}"
                                type="button"
                                on:click={selectConfig}
                                >{utils.getLabel(
                                    "config",
                                    labels,
                                    $language,
                        ...
                        {#if activeTabs.desc}
                            <a
                                class="nav-link {selectedTab === 'desc'
                                    ? 'active'
                                    : ''}"
                                type="button"
                                on:click={selectDesc}
                    ...
                    <div class="p-1 mt-2">
                        ...
                        <div class="mb-2">
                            ...
                            >
                                ...
                                {#each widgets.localTypes as widgetType}
                                    <option
                                        selected={widgetType == selectedType}
                                        value={widgetType}>{widgetType}</option
                                    >
                                {/each}
                        ...
                        {#if singleDeviceMode == 1 && widgets.isVisible(selectedType, "dev_id")}
                            <div class="input-group mb-2">
                                <label for="dev_id" class="form-label me-2"
                                    >{utils.getLabel(
                                        "eui",
                                        labels,
                                        $language,
                        ...
                        {#if singleDeviceMode == 0 && widgets.isVisible(selectedType, "group")}
                            <div class="input-group mb-2">
                                <label for="group" class="form-label me-2"
                                    >{utils.getLabel(
                                        "group",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "imageUrl")}
                            <div class="mb-2">
                                <label for="imageUrl" class="form-channels"
                                    >{utils.getLabel(
                                        "image_url",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "dashboardID")}
                            <div class="mb-2">
                                <label for="dashboardID" class="form-channels"
                                    >{utils.getLabel(
                                        "dashboard_eui",
                                        labels,
                                        $language,
                ...
                {#if selectedTab === "extended"}
                    <div class="p-1 mt-2">
                        {#if widgets.isVisible(selectedType, "channel") && singleDeviceMode != 2}
                            <div class="mb-2">
                                <label for="channel" class="form-channels"
                                    >{utils.getLabel(
                                        "measurements",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "project")}
                            <div class="mb-2">
                                <label for="project" class="form-channels"
                                    >{utils.getLabel(
                                        "project_name",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "rounding")}
                            <div class="mb-2">
                                <label for="rounding" class="form-channels"
                                    >{utils.getLabel(
                                        "rounding",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "icon")}
                            <div class="mb-2">
                                <label for="icon" class="form-channels"
                                    >{utils.getLabel(
                                        "icons",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "commandText") && config[index].commandType != "json"}
                            <div class="mb-2">
                                <label for="commandText" class="form-channels"
                                    >{utils.getLabel(
                                        "commandText",
                                        labels,
                                        $language,
                        ...
                        {#if widgets.isVisible(selectedType, "commandJSON") && config[index].commandType == "json"}
                            ...
                            <textarea
                                ...
                                rows="5"
                                bind:value={config[index].commandJSON}
                            ></textarea>
                            <small class="text-xs"
                                >JSON to send as command</small
                            >
                        {/if}
                ...
                {#if selectedTab === "chart"}
                    <div class="p-1 mt-2">
                        ...
                        <select
                            id="chart_type"
                            class="form-select form-select-sm"
                            bind:value={config[index].chartType}
                        >
            ...
            -->
                    ...
                    <div class="p-1 mt-2">
                        ...
                        <select
                            id="format"
                            class="form-select form-select-sm"
                            bind:value={config[index].format}
                        >
                            <option
                                selected={"standard" == config[index].format}
                                value="standard">standard</option
                            >
                            <option
                                selected={"timeseries" == config[index].format}
                                value="timeseries">timeseries</option
                            >
                        </select>
                    </div>
                    <div class="p-1 mt-2">
                        ...
                        <select
                            id="format"
                            class="form-select form-select-sm"
                            bind:value={config[index].timeUnit}
                        >
                            <option
                                value=""
                                selected={config[index].timeUnit == "" ||
                                    config[index].timeUnit == undefined}
                            >
                                {utils.getLabel(
                                    "auto_setting",
                                    labels,
                            ...
                            <option
                                value="quarter"
                                selected={config[index].timeUnit == "quarter"}
                            >
                                {utils.getLabel(
                                    "quarters",
                                    labels,
                            ...
                            <option
                                value="week"
                                selected={config[index].timeUnit == "week"}
                            >
                                {utils.getLabel(
                                    "weeks",
                                    labels,
                            ...
                            <option
                                value="day"
                                selected={config[index].timeUnit == "day"}
                            >
                                {utils.getLabel(
                                    "days",
                                    labels,
                            ...
                            <option
                                value="hour"
                                selected={config[index].timeUnit == "hour"}
                            >
                                {utils.getLabel(
                                    "hours",
                                    labels,
                            ...
                            <option
                                value="minute"
                                selected={config[index].timeUnit == "minute"}
                            >
                                {utils.getLabel(
                                    "minutes",
                                    labels,
                ...
                {#if selectedTab === "config"}
                    ...
                    <div class="p-1 mt-2">
                        ...
                        <textarea
                            ...
                            style="font-size: 14px"
                            rows="5"
                            bind:value={config[index].config}
                        ></textarea>
                        <small class="text-xs"
                            >Optional widget configuration (JSON)</small
                        >
                        <br />
                    </div>
                {/if}
                ...
                {#if selectedTab === "desc"}
                    <div class="p-1 mt-2">
                        ...
                        <textarea
                            ...
                            style="font-size: 14px"
                            rows="5"
                            bind:value={config[index].description}
                        ></textarea>
                        <small class="text-xs"
                            >Dla kontrolek typu 'ramka informacyjna' pojawi się
                            w ramce.</small
                        >
                        <br />
                    </div>
                ...
                <div class="mt-2">
                    <button
                        ...
                        >{utils.getLabel("cancel", labels, $language)}</button
                    >
                    <button
                        type="button"
        ...
        {:else}
            <div class="alert alert-danger" role="alert">Brak konfiguracji</div>
            <div class="mt-2">
                <button
                    type="button"
                    class="btn btn-secondary"
...
<DeviceSelector bind:showDeviceSelectorModal callback={setDevice}
></DeviceSelector>
<GroupSelector bind:showGroupSelectorModal callback={selectGroup}
></GroupSelector>
